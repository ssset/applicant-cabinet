...
// Базовый URL бэкенда
const BASE_URL = 'http://localhost:8000'; // Убедитесь, что это соответствует вашему бэкенду
                                    ...
                                    <div className="mt-2">
                                        {profile.photo ? (
                                            <img
                                                ...
                                                alt="Фото студента"
                                                className="max-w-[150px] h-auto rounded-md border border-gray-200"
                                                onError={(e) => {
